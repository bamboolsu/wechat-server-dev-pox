...
public class MenuManager {
    ...
    private static Menu getMenu() {
        ...
        btn13.setType("view");
        btn13.setUrl(
                "http://mp.weixin.qq.com/mp/getmasssendmsg?__biz=MzI4MTE4MDMwMQ==#wechat_webview_type=1&wechat_redirect");
        ...
        /*
         * ViewButton btn2 = new ViewButton(); btn2.setName("BUY好货");
         * btn2.setType("view"); btn2.setUrl("http://m.maidehao.com/");
         */

        /*
         * ClickButton btn2 = new ClickButton(); btn2.setName("找小德去");
         * btn2.setType("click"); btn2.setKey("findlittlede");
         */

        /*
         * ClickButton btn2 = new ClickButton(); btn2.setName("个人中心");
         * btn2.setType("click"); btn2.setKey("membercenter");
         */
        ...
        /*
         * ViewButton btn31 = new ViewButton(); btn31.setName("店铺测试");
         * btn31.setType("view"); btn31.setUrl(
         * "http://mp.weixin.qq.com/bizmall/mallshelf?id=&t=mall/list&biz=MzI4MTE4MDMwMQ==&shelf_id=1&showwxpaytitle=1#wechat_redirect"
         * );
         */
        ...
        /*
         * ViewButton btn33 = new ViewButton(); btn33.setName("内部测试");
         * btn33.setType("view"); btn33.setUrl("http://m.maidehao.com/");
         * //btn33.setUrl("http://m.maidehao.com/before_index.html");
         * 
         * ViewButton btn34 = new ViewButton(); btn34.setName("testting");
         * btn34.setType("view");
